...
$articleRea=[
	...
	"],
	["id"=>3, "titre"=> "Ptitdej.fr", "image"=>"ptidej", "contenu"=>""],
	["id"=>4, "titre"=> "Un TP React", "image"=>"pendu","contenu"=>""],
	["id"=>5, "titre"=> "Quoicuisiner.fr", "image"=>"cuisiner", "contenu"=>""],
];
